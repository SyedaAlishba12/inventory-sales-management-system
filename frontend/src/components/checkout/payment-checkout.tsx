    ...
    if (category === "ONLINE_GROUP") {
      if (provider === "CARD") {
        ...
        if (!bankReference.trim()) {
          next.bankReference = "Enter the transaction reference after transferring.";
        }
      }
    }
            ...
            {provider === "BANK_TRANSFER" && (
              <div className="space-y-3">
                <div className="rounded-lg border bg-muted/40 p-3 text-sm">
                  <p className="mb-2 font-medium">Transfer to this account</p>
                  <div className="space-y-1 text-muted-foreground">
                    <div className="flex justify-between">
                      <span>Account title</span>
                      <span className="font-medium text-foreground">Inventra Pvt Ltd</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Account number</span>
                      <span className="font-medium text-foreground">0123-4567-8901</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Bank</span>
                      <span className="font-medium text-foreground">Meezan Bank</span>
                    </div>
                  </div>
                </div>

                <div className="space-y-1.5">
                  <Label htmlFor="bank-select">Transferring from</Label>
                  <select
                    id="bank-select"
                    value={bank}
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="bank-reference">Transaction reference number</Label>
                  <Input
                    id="bank-reference"
                  ...
                  <p className="text-xs text-muted-foreground">
                    Enter this after completing the transfer in your banking app.
                  </p>
