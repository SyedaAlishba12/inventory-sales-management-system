      ...
      {PAYMENT_METHODS.map((method) => {
        ...
        return (
          <label
            key={method.value}
            className={cn(
              "flex cursor-pointer items-start gap-3 rounded-xl border bg-card p-3 transition hover:bg-muted",
          ...
          >
            ...
            <span>
              <span className="flex items-center gap-1.5 text-sm font-semibold"><Icon className="size-4" />{method.label}</span>
