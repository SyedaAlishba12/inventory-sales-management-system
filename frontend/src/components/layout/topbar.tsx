  ...
  return (
    <header className="sticky top-0 z-20 flex h-16 items-center gap-3 border-b border-[#D7E0E3] bg-white px-4 text-[#0F4C5C] backdrop-blur sm:px-6">
      <Button
        variant="ghost"
        size="icon"
        className="text-[#52646A] hover:bg-[#EAF0F2] hover:text-[#0F4C5C] lg:hidden"
        onClick={onMenuClick}
      ...
      <div className="relative hidden w-full max-w-md sm:block">
        ...
        <Input
          className="border-[#D7E0E3] bg-[#F3F6F8] pl-9 text-[#0F4C5C] shadow-none placeholder:text-[#7A8B91] focus-visible:ring-[#78A394]"
